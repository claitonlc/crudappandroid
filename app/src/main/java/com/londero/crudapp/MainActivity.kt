...
import com.londero.crudapp.adapter.UserAdapter
import com.londero.crudapp.data.AppDatabase
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSearch.setOnClickListener {
            ...
            getData()
            Toast.makeText(applicationContext, "Insera um nome para pesquisar!", LENGTH_SHORT).show()
        }
    }
}
